...
<body>
 ...
 %>
	...
	<div class="container">
		...
		%>
		<div class="container">
			<div class="alert <%=alert.getTipo()%> alert-dismissible fade show"
				role="alert">
				<p><%=alert.getTexto()%></p>
			...
			<div class="col-lg-3">
				...
				<ul class="list-group">
					...
					<li
						...
						<a href="inicio?id=<%=v.getId()%>"><%=v.getNombre()%></a> <a
						href="inicio?id=<%=v.getId()%>&op=<%=HomeController.OP_ELIMINAR%>"><i
				...
				<ul class="list-group">
					<%
						ArrayList<Video> videos_vistos = (ArrayList<Video>) session.getAttribute("videosReproducidos");
					...
					<li><p>
							Por favor, <a href="#" onclick="focusLogin">Inicial Sesion</a>
							para guardar tus videos reproducidos
						</p></li>
			...
			<div class="col-lg-9">
				...
				<div class="card mt-4">
					...
					<iframe id="iframe" width="823" height="415"
						src="https://www.youtube.com/embed/<%=videoInicio.getId()%>?autoplay=1"
